...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
  ...
  ${d.disclaimer ? `<tr><td colspan="2" style="padding:14px 0 0 0;border-top:1px solid ${divider};"><div style="font-family:${fontFamily};font-size:${baseSize - 3}px;color:${muted};line-height:1.5;padding-top:10px;">${esc(d.disclaimer)}</div></td></tr>` : ''}
</table>`;

...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
  ...
  ${layout.sectionDividers ? `<tr><td data-esg-region="rule" align="center" style="padding:${layout.gap}px 0 0 0;">
  ...
  <tr><td data-esg-region="contact" align="center" style="padding-top:${layout.gap}px;font-family:${fontFamily};font-size:${baseSize - 1}px;color:${muted};line-height:1.6;text-align:center;">${contactPieces.join(' &nbsp;·&nbsp; ')}</td></tr>
  ${socialRow ? `<tr><td data-esg-region="socials" align="center" style="padding-top:${layout.gap}px;"><div style="display:inline-block;">${socialRow}</div></td></tr>` : ''}
  ${d.bannerUrl ? `<tr><td data-esg-region="banner" align="center" style="padding-top:${layout.gap}px;">${
    d.bannerLink
  ...
  ${d.companyLegal ? `<tr><td data-esg-region="legal" align="center" style="padding-top:${layout.gap}px;"><div style="text-align:center;">${legal}</div></td></tr>` : ''}
  ${d.disclaimer ? `<tr><td data-esg-region="disclaimer" align="center" style="padding-top:${layout.gap}px;"><div style="font-family:${fontFamily};font-size:${baseSize - 3}px;color:${muted};line-height:1.5;text-align:center;">${escMultiline(d.disclaimer)}</div></td></tr>` : ''}
</table>`;
